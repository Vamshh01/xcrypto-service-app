...
import {Container , Box, HStack,Radio,RadioGroup,VStack,Text,Image, Stat, StatNumber,StatLabel, StatHelpText, StatArrow, Badge,Progress,Button } from '@chakra-ui/react';
import Loader from './Loader';
import {server} from './main.jsx';
import { useParams } from 'react-router-dom';
import ErrorComponent from './ErrorComponent';
import Chart from './assets/Chart.jsx';
  ...
  return (
    ...
    {loader?<Loader></Loader> : (
      <>
       ...
       <Box width={"full"} borderWidth={1} justifyContent={"center"}>
    ...
    <VStack p={"16"} alignItems={"flex-start"} spacing={"4"}>
      <Text alignSelf={"center"} opacity={"0.7"}>Last Updated on {Date(coin.market_data.last_updated).split("G")[0]}</Text>
      ...
      <Badge bgColor={"blackAlpha.800"} color={"whiteAlpha.800"} fontSize={"2xl"} >{`#${coin.market_cap_rank}`}</Badge>
